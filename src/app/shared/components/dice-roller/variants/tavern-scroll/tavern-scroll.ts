...
@Component({
  selector: 'app-dice-variant-tavern-scroll',
  templateUrl: './tavern-scroll.html',
  styleUrl: './tavern-scroll.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class TavernScrollVariant implements OnInit {
  ...
  readonly countsSnapshot = computed(() => this.counts());
