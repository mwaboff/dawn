...
import { TavernScrollVariant } from './tavern-scroll';
...
describe('TavernScrollVariant', () => {
  let fixture: ComponentFixture<TavernScrollVariant>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TavernScrollVariant);
  ...
  it('shows hope label when duality outcome is hope', () => {
    service.history.set([
      makeResult({
        id: 'h1',
        total: 15,
        duality: { hope: 9, fear: 5, outcome: 'hope' },
      }),
    ]);
    service.isOpen.set(true);
    fixture.detectChanges();
  ...
  it('shows fear label when duality outcome is fear', () => {
    service.history.set([
      makeResult({
        id: 'f1',
        total: 10,
        duality: { hope: 3, fear: 9, outcome: 'fear' },
      }),
    ]);
    service.isOpen.set(true);
    fixture.detectChanges();
  ...
  it('shows crit label when duality outcome is crit', () => {
    service.history.set([
      makeResult({
        id: 'c1',
        total: 24,
        duality: { hope: 12, fear: 12, outcome: 'crit' },
      }),
    ]);
    service.isOpen.set(true);
    fixture.detectChanges();
  ...
  it('pre-fills dice counts from consumePendingRequest on init', () => {
    ...
    const newFixture = TestBed.createComponent(TavernScrollVariant);
